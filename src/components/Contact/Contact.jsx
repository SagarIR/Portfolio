          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">
                sagar.18beceg081@gmail.com
              </span>
              <a
                href="mailto:sagar.18beceg081@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">7874937762</span>
              <a
                href="https://api.whatsapp.com/send?phone=7874937762, more information!"
                className="contact__button"
              >
                Write me
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
          ...
          <form className="contact__form" ref={form} onSubmit={sendEmail}>
            ...
            <div className="contact__form-div">
              ...
              <input
                ...
                name="phone"
                className="contact__form-input"
                placeholder="Insert Your Phone No"
